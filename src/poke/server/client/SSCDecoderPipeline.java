...
/*
 * Team Insane:
 * Pipeline decoder for ServerClient.
 */
/*
 * copyright 2012, gash
 * 
...
public class SSCDecoderPipeline  implements ChannelPipelineFactory {
	private ServerSideClientHandler handler = new ServerSideClientHandler();

	public SSCDecoderPipeline() {
	}
